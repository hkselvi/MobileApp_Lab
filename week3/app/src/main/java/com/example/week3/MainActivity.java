...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(intent, POST_REQUEST);  //postu gösterecek
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == POST_REQUEST && resultCode == Activity.RESULT_OK){
            ...
            postList.add(post);
            ((PostAdapter)listView.getAdapter()).notifyDataSetChanged(); //bu çağırılmadığında listview update olmuyor
        }
    }
}